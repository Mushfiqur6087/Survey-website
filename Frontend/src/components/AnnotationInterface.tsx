...
interface AnnotationInterfaceProps {
  ...
  mode?: 'random' | 'all' | 'custom';
  trackCount?: number; // For 'random' mode (default 10)
  trackIds?: number[]; // For 'custom' mode

  // Session configuration
  sessionPrefix?: string; // e.g., 'survey', 'full-annotation'
...
export default function AnnotationInterface({
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-blue-700">
              You'll analyze {trajectories.length} trajectory curves and place strategic points
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <p className="text-green-700">
                Colored dots show your completion status across all trajectories:
              </p>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <ul className="space-y-2 text-yellow-700">
                ...
                <li>
                  • Complete all <strong>trajectories</strong> to submit
                </li>
                <li>
          ...
          <div className="space-y-3">
            <div className="bg-yellow-50 p-4 rounded-lg">
              ...
              <p className="text-yellow-700">
                You must place the required number of knots on all
  ...
  useEffect(() => {
    if (trajectories.length > 0 || annotationMode || sessionId) {
      ...
      localStorage.setItem(`${sessionPrefix}-state`, JSON.stringify(stateToSave));
    }
  ...
  const loadTrajectories = async () => {
    ...
    try {
      ...
      switch (mode) {
        case 'random':
          // Get random tracks from backend
          selectedTrackIds = await trajectoryAPI.getRandomTrackIds(trackCount);
          break;

        case 'all':
          // Get all track IDs
          const allTrackIds = await trajectoryAPI.getUniqueTrackIds();
          selectedTrackIds = allTrackIds;
          break;

        case 'custom':
          // Use provided track IDs
          if (!trackIds || trackIds.length === 0) {
            throw new Error('Custom mode requires trackIds prop');
          }
  ...
  const handlePasswordSubmit = async (password: string) => {
    ...
    try {
      ...
      alert(
        "Annotation completed successfully! You will now be redirected.",
      );
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <p className="text-gray-600">
              Loading trajectories for annotation...
            </p>
          </div>
            ...
            {!annotationMode ? (
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3 text-gray-600">
                  <p>• You will be shown {trajectories.length} trajectory curves</p>
                  <p>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            <p className="text-gray-500">
              No trajectories loaded. Click the button above to load
              trajectories.
            </p>
            <button
